...
Same STM Canna team as the RocketBox Pro, with the same support network and parts infrastructure. For operators planning to scale, the familiarity with the platform makes upgrading to the Pro a smoother transition.

## Operator Impressions

The go-to recommendation for mid-size dispensaries in the $20K–$30K budget range. Operators who upgrade from the 2.0 to the Pro often cite it as their best ROI decision — the 2.0 paid for itself before they needed to scale up.
